...
if (isset($_POST["signin"])){
  ...
  $result = mysqli_query($db, "SELECT * FROM user WHERE email ='$emaillogin'");
...
if (isset($_POST["signup"])) {
  ...
  if (registrasi ($_POST) > 0 ) {
    $add = "Anda berhasil Mendaftar, Silahkan Login";
  } else {
    mysqli_error($db);
  }
}
    ...
    <div class="main">
      <div class="container a-container" id="a-container">
        <form class="form" id="b-form" method="post" action="">
          ...
          <input class="form__input" type="text" placeholder="Email" name="emaillogin"/>
          <input class="form__input" type="password" placeholder="Password" name="passwordlogin"/><a
            class="form__link"
            >Forgot your password?</a>
            <?php if (isset($error)) :?>
            <p class="form__link" style="color: red;">username atau password salah kocak</p>
           <?php endif; ?>
            <?php if (isset($add)) :?>
            <p class="form__link" style="color: green; font-style:italic"><?= $add; ?></p>
           <?php endif; ?>
